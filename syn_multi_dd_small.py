...
def process(options):
    ...
    output_path = base_directory / 'synthetic_tests_dd_test_small_2' / options['generator'] / f"{get_option_filename(options)}"
    ...
    save_X, save_y = stream_ABA.next_sample(options['run_length'])

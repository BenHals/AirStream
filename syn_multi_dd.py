...
def process(options):
    ...
    stream_ABAC = ConceptDriftStream(stream=stream_ABA, drift_stream=stream_C, position=options['positions'][2], width=options['widths'][2], random_state=options['seed'])
    stream_ABACB = ConceptDriftStream(stream=stream_ABAC, drift_stream=stream_B, position=options['positions'][3], width=options['widths'][3], random_state=options['seed'])
    stream_ABACBA = ConceptDriftStream(stream=stream_ABACB, drift_stream=stream_A, position=options['positions'][4], width=options['widths'][4], random_state=options['seed'])
    stream_ABACBAC = ConceptDriftStream(stream=stream_ABACBA, drift_stream=stream_C, position=options['positions'][5], width=options['widths'][5], random_state=options['seed'])
    ...
    stream_ABACBAC.prepare_for_use()

    save_X, save_y = stream_ABACBAC.next_sample(options['run_length'])
...
if __name__ == "__main__":
    ...
    options = {
        ...
        'positions': [5000, 12000, 19000, 26000, 33000, 40000],
        # 'positions': [5000, 10000],
        # 'widths': [1, 4000, 1, 4000, 1, 4000, 4000, 4000],
        'widths': [1, 4000, 1, 4000, 4000, 4000],

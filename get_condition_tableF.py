...
df.to_pickle(pathlib.Path.cwd() / f"{data_name}-condition-data.pickle")

#%%
df = pd.read_pickle(pathlib.Path.cwd() / f"{data_name}-condition-data.pickle")
...
#%%
table.to_csv(pathlib.Path.cwd() / f"{data_name}-condition-table.csv")

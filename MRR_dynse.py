...
# base_directory = pathlib.Path(r"H:\PhD\Paper2-AdaptionRepair\ReturnScaleFin\experiments") / "Arrowtown"
base_directory = pathlib.Path(r"H:\PhD\Paper2-AdaptionRepair\ReturnScaleFin\experiments") / "BMSClean"
...
df_g = df.groupby(['dataset', 'system']).agg(('mean', 'std', 'count'))
...
# df_g[['ks_ho', 'mean_reciprocal_rank_ho', 'accuracy_ho']]
df_g[['mean_reciprocal_rank_ho', 'ks_ho', 'accuracy_ho']]


# %%
# df_g[['mean_reciprocal_rank_ho', 'ks_ho', 'accuracy_ho']].to_csv(f'MRR_dynse_BMSClean.csv')
df_g[['mean_reciprocal_rank_ho', 'ks_ho', 'accuracy_ho']].to_csv(f'C:\MRR_dynse_BMSClean.csv')
